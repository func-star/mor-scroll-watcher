...
var ScrollWatcherItem = function (_Component) {
	...
	function ScrollWatcherItem() {
		...
		return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = ScrollWatcherItem.__proto__ || Object.getPrototypeOf(ScrollWatcherItem)).call.apply(_ref, [this].concat(args))), _this), _this.domInfo = {}, _this.isEmited = false, _temp), _possibleConstructorReturn(_this, _ret);
	}
	...
	_createClass(ScrollWatcherItem, [{
		...
		value: function componentDidMount() {
			...
			_ctrl2.default.on(this.watcherId, this.watcher.bind(this));
		}
	}, {
		key: 'watcher',
		...
		value: function render() {
			var _props = this.props,
			    ...
			    props = _objectWithoutProperties(_props, ['className', 'onWatcher', 'children']);
