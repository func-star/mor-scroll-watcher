...
var ScrollWatcherItem = function (_Component) {
	...
	function ScrollWatcherItem() {
		...
		return _possibleConstructorReturn(this, (ScrollWatcherItem.__proto__ || Object.getPrototypeOf(ScrollWatcherItem)).apply(this, arguments));
	}
	...
	_createClass(ScrollWatcherItem, [{
		...
		value: function componentDidMount() {
			...
			this.monaWatcher.id = _keyStore2.default.getItemKey(this.watcherId);
			_ctrl2.default.on(this.watcherId, this.monaWatcher);
		}
	}, {
		key: 'watcher',
		value: function watcher(info) {
			if (this.offsetTop - info.scrollTop < info.wrapHeight - info.bottomEmit) {
				_ctrl2.default.off(this.watcherId, this.monaWatcher);
